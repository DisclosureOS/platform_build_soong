...
func Banner(make_vars map[string]string) string {
	b := &bytes.Buffer{}
        ...
        fmt.Fprintln(b, "============================================")
	fmt.Fprintf(b, "        DisclosureOS-%s %s %s\n", make_vars["DISCLOSURE_VERSION"], make_vars["PLATFORM_VERSION"], make_vars["TARGET_PLATFORM_VERSION"] )
	fmt.Fprintln(b, "============================================")
	fmt.Fprintln(b, "============================================")
	for _, name := range BannerVars {
		if make_vars[name] != "" && name != "DISCLOSURE_VERSION" {
			fmt.Fprintf(b, "%s=%s\n", name, make_vars[name])
		}
	}
	fmt.Fprint(b, "============================================")
